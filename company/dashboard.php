...
<html lang="en">
  ...
  <br>
    ...
    <?php if(isset($_SESSION['jobPostUpdateSuccess'])) { ?>
      <div class="row successMessage" style="text-align: center; color: blue; font-size: 28px;">
        <div class="alert alert-success" style="text-align: center; color: blue; font-size: 28px;">
