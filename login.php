...
<html lang="en">
  ...
  <div style="background-color: #053a5a; height: 65px;">
    <p style="font-size: 34px; color: white; text-align: center; line-height: 65px;">Candidate Login</p>
  </div>
        ...
        <div class="row" align="center">
            <form method="post" action="checklogin.php">
              ...
              <tr>
                <td></td>
                <td></td>
                <td><a href="forgot-password.php" style="font-size: 15px; color: blue;">Forgot Password? Click Here...</a></td>
              </tr>
