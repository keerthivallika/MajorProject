...
<html lang="en">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
          ...
          if(isset($_SESSION['id_user']) && empty($_SESSION['companyLogged'])) {
            ?>
            <li style="font-size: 25px;"><a href="user/dashboard.php">Dashboard</a></li>
            <li style="font-size: 25px;" ><a href="logout.php">Logout</a></li>
            <?php 
            } else if(isset($_SESSION['id_user']) && isset($_SESSION['companyLogged'])){
            ?>
            <li style="font-size: 25px;"><a href="company/dashboard.php">Dashboard</a></li>
            <li style="font-size: 25px;"><a href="logout.php">Logout</a></li>
            <?php } else { 
            ?>
  ...
  <div style="background-color: #053a5a; height: 65px;">
    <p style="font-size: 34px; color: white; text-align: center; line-height: 65px;">Login</p>
  </div>
  ...
  <div class="container" align="center">
    <div class="row">
      <div style="color: black;">
        <h1 style="color: black; line-height: 55px;"><a href="login.php" style="color: black;background: #3498db;
  ...
  text-decoration: none;"> Candidate Login </a></h1>
  
      </div>
      <br>
      <br>
      <div style="color: black;">
        <h1 style="color: black; line-height: 55px;"><a href="company-login.php" style="color: black;background: #3498db;
  background-image: -webkit-linear-gradient(top, #3498db, #2980b9);
  background-image: -moz-linear-gradient(top, #3498db, #2980b9);
  background-image: -ms-linear-gradient(top, #3498db, #2980b9);
  background-image: -o-linear-gradient(top, #3498db, #2980b9);
  ...
  background-image: -o-linear-gradient(top, #3cb0fd, #3498db);
  background-image: linear-gradient(to bottom, #3cb0fd, #3498db);
  text-decoration: none;"> Company Login </a></h1>
      </div>
      <br>
      <br>
      <div style="color: black;">
        <h1 style="color: black; line-height: 55px;"><a href="admin/index.php" style="color: black;background: #3498db;
  background-image: -webkit-linear-gradient(top, #3498db, #2980b9);
  background-image: -moz-linear-gradient(top, #3498db, #2980b9);
  background-image: -ms-linear-gradient(top, #3498db, #2980b9);
  background-image: -o-linear-gradient(top, #3498db, #2980b9);
  ...
  background-image: -o-linear-gradient(top, #3cb0fd, #3498db);
  background-image: linear-gradient(to bottom, #3cb0fd, #3498db);
  text-decoration: none;"> Placement Login </a></h1>
      </div>
    </div>
  </div>
