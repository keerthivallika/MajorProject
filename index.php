      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
          ...
          if(isset($_SESSION['id_user']) && empty($_SESSION['companyLogged'])) {
            ...
            <li style="padding-right: -25px;"><a href="http://localhost/Placement%20Management/quiz/mocktest.html" target="blank" style="font-size: 24px; color: #053a5a; line-height: 42px;">Mock tests</a></li>
