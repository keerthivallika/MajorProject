...
<html>
  ...
  <div style="background-color: #053a5a; height: 65px;">
    <p style="font-size: 34px; color: white; text-align: center; line-height: 65px;">Register as a Student</p>
  </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="date" id="dob" name="dob" placeholder="Date of Birth *" min="1995-01-01" max="2023-12-12" required="">
              </div>
