...
<html lang="en">
  ...
  <div style="background-color: #053a5a; height: 65px;">
    <p style="font-size: 34px; color: white; text-align: center; line-height: 65px;">My Dashboard</p>
  </div>
  ...
  <br>
    ...
    <div class="container">
      ...
      <div>
                <p id="successMessage" style="text-align: center; color: blue; font-size: 28px;">You have applied successfully!</p>
              </div>
